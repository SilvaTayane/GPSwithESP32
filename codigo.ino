...
#define GPS_RX 16             // GPIO21 conectado ao TX do GPS
...
const char* ssid = "name_wifi";       // Your WiFi network name (SSID)
...
// API Authentication
const char* apiKey = "APIKey";    // Your unique GeoLinker API key
